...
if __name__ == '__main__':
  ...
  #  ref_id=1012....1021
    ...
    ################################################
            ...
            thresh_list = .2
            boxes,scores,max_score = nms(scores, w_array, h_array, thresh_list)
            ####################33
            limit_boxes=7
            # set the limit of boxes
            boxes=boxes[:limit_boxes]
            scores=boxes[:limit_boxes]
          ...
          ############################3
            ...
            for index,box in enumerate(boxes):
                ...
                # image_path = '/home/mayank_sati/Desktop/one_Shot_learning/farmington/traffic_shot_2019-05-31-13-38-28_4_0003/1559324341001511289.jpeg'
                # image_path = 'result.jpeg'
                dataset_2 = ImageDataset_2(Path(template_dir), (image_path), thresh_csv='../thresh_template.csv')
                # print(" time taken in data processing", (time.time() - t1) * 1000)
