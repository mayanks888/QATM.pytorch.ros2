...
if __name__ == '__main__':
    ...
    # parser.add_argument('-s', '--sample_image', default='/home/mayank_sati/Desktop/git/2/AI/QATM/data/sample/2.jpg')
    parser.add_argument('-s', '--sample_image', default='/home/mayank_sati/Desktop/git/2/AI/QATM/data/sample/gwm_734.jpg')
    ...
    print('total time take nms', (time.time() - t2) * 1000)
    ...
    print('total time take ', (time.time()-t5)*1000)
