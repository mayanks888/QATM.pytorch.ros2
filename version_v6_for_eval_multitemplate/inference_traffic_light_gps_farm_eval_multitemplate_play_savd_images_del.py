...
from data_preprocess_for_inference import find_template,find_template_2
from utils import *
...
if __name__ == '__main__':
    ...
    # template_root = "/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/evaluation/valid_farm"
    # input_folder = '/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/evaluation/valid_farm'
    # csv_name = '/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/2019-09-27-14-39-41_test_scaled_eval_farm.csv'
#######################################################################################################################33
    temp_save_path = "../data/cust_template"
...
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    pred_save_path='/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/evaluation/predicition_qatm_saved_2'
    ...
    ################################################
            ...
            if len(boxes.shape) == 3:
                ...
                # scores = scores[:limit_boxes]
                d_img = plot_result_multi_univ(dataset.image_raw, boxes, indices, show=False, save_name='result_sample.png')
            ################################################################################
...
###########################################################################33333
            ...
            txt_file_path = pred_save_path + "/" + txt_file_name
    ...
    # $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
                    ...
                    f.write(str('traffic_light') + " " + str(scores[index_1]) + " " + " ".join([str(int(2*a)) for a in bb]) + '\n')

                saved_path='/home/mayank_sati/Desktop/cool_6/'
                img_sav_name=saved_path+filename

                cv2.imwrite(img_sav_name,image_scale)
                if show:
                    cv2.imshow('new_frame', image_scale)
                    ch = cv2.waitKey(1000)
                    if ch & 0XFF == ord('q'):
                        cv2.destroyAllWindows()
                    # cv2.waitKey(1)
            ...
            print('ERROR...object detection failed for filename: {fn}, Check file type... '.format(fn=group.filename),
                  '\n')
        except:
            print('ERROR...object detection failed for filename: {fn}, Check file type... '.format(fn=group.filename),
                  '\n')
