...
#     # return model
#     num_classes=4096
#     # model = torchvision.models.resnet.ResNet(num_classes,torchvision.models.resnet.BasicBlock, [3, 4, 23, 3])
#     model = torchvision.models.resnet.ResNet(torchvision.models.resnet.BasicBlock, [3, 4, 23, 3])
#     if pretrained:
#         model.load_state_dict(torch.utils.model_zoo.load_url(model_urls['resnet101'], model_dir='../resnet101'))
#     return EmbeddingNet(model)
